    ...
    <div className="min-h-screen text-white">
      ...
      <main className="max-w-[900px] mx-auto px-4 py-8 relative z-10">
        <div className="border border-dark-border rounded-xl bg-dark-card p-7 glow-orange">
          ...
          <Link
            to="/"
            className="inline-block mt-4 text-neon-orange border border-neon-orange rounded-lg px-4 py-2.5 text-sm transition-all hover:bg-neon-orange/10 hover:-translate-y-0.5"
          >
